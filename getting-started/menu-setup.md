...
```text
- Menu: Main menu
-- Category: Curry & Pizza
---- Dish: Chicken Tikka Massala 
---- Dish: Lamb Buna 
---- Dish: Meat Feast Pizza 
-- Category: Sides
---- Dish: Chicken Wings
---- Dish: Fries
-- Category: Drinks
...
We highly recommend that you use the website [https://www.birme.net](https://www.birme.net) or [https://tinypng.com/](https://tinypng.com/) to optimize all your images. Given that the maximum image width is only around 600 pixels, it's best to make sure all your images are no wider than that. This is going to help significantly with your page load time especially for mobile customers. If you are using your own images please ensure you have the Copy Rights 
